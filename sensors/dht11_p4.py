...
dht_device = adafruit_dht.DHT11(board.D23)  # Gunakan GPIO 23
...
CONFIG_PATH = os.path.join(os.path.dirname(__file__), "config", "setting_dht11_p4.json")
...
def generate_device_id():
    ...
    if serial and serial != "0000000000000000":
        device_id = str((binascii.crc32(serial.encode()) & 0xffffffff) + 3)
    else:
        device_id = str((binascii.crc32(mac_address.encode()) & 0xffffffff) + 3)
